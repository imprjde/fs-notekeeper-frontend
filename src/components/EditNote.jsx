...
const EditNote = () => {
  ...
  const [isLoading, setIsLoading] = useState(false);
  const { id } = useParams();
  const { isLogoutModalOpen, editableData, setEditableData } =
    useContext(appContext);
  const navigate = useNavigate();

  console.log("KKKKKK", editableData);
          ...
          <div className="space-y-3 pt-3">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditedData({ ...editableData, title: e.target.value })
                }
                type="text"
                id="title"
                name="title"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditedData({ ...editableData, category: e.target.value })
                }
                type="text"
                id="category"
                name="category"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEditedData({ ...editableData, content: e.target.value })
                }
                id="content"
                name="content"
                rows="2"
