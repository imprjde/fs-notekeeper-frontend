      ...
      <div className="m-auto h-full justify-between flex items-center pl-3 pr-2 md:px-8">
        ...
        {userInfo !== null ? (
          ...
          <div className="space-x-3 mr-5 hidden md:flex">
            <Link
              to="/signup"
              className="relative inline-flex items-center justify-start px-5 py-1.5 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group"
            >
