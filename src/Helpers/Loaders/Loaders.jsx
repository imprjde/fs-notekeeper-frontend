...
export const updateProfileLoader = (
  <div role="status">
    <svg
      aria-hidden="true"
      className="inline w-4 h-4 text-gray-900 animate-spin dark:text-gray-600 fill-white"
      viewBox="0 0 100 101"
      fill="none"
...
export const resetLoader = (
  <div role="status">
    <svg
      aria-hidden="true"
      className="inline w-5 h-5 text-black font-bold  animate-spin dark:text-gray-600 fill-white"
      viewBox="0 0 100 101"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
